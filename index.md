...
In Summer and Fall 2025, I interned as an `rgb(9, 105, 218)`**Applied Scientist in Amazon**. Where I applied reinforcement learning and Chain-of-Thought to train a multimodal agent (MLLM) to use a set of tools (foundational models) to find visual defects in customer uploaded images. We improved the classification performance by **6.1%**. 
