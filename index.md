...
In Summer and Fall 2024, I interned as an **Applied Scientist in Amazon**. Where I applied reinforcement learning and Chain-of-Thought to train a multimodal agent (MLLM) to use a set of tools (foundational models) to find visual defects in customer uploaded images. We improved the classification performance by **6.1%**. 
